...
Assert-Contains $Source 'var VERSION = "0\.29";' "HTA internal version is not 0.29."
...
Assert-Contains $Source '<col style="width:4%"><col style="width:46%">' "Fixed Paths file-path column is not maximized."
Assert-Contains $Source '<col style="width:48%"><col style="width:9%">' "Programs file-path column is not maximized."
Assert-Contains $Source '\.path-table td\s*\{\s*padding-right: 8px;\s*padding-left: 8px;' "Path controls do not use an exact 16px horizontal gap."
