...
Assert-Contains $Source 'var VERSION = "0\.76";' "HTA internal version is not 0.76."
$CommonApplyIndex = $Source.IndexOf('onclick="applyPaths()">APPLY PATHS</button>')
$ProgramApplyIndex = $Source.IndexOf('onclick="applyCurrentProgram()">APPLY ')
