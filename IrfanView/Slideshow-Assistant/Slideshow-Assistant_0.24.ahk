...
; Version: 0.24
; Multiple instances are allowed; each instance binds to one IrfanView process.
...
/*  CHECK WHETHER THIS INSTANCE'S BOUND IRFANVIEW PROCESS STILL EXISTS
    The old script can begin exit work while another script binds to a new process.
 */
isBoundIrfanViewProcessRunning()
{
    ...
    return (ErrorLevel = bound_irfanview_process_id)
}
